...
function addStyles() {
    ...
    style.textContent = `
        ...
        #dasiwa-monitor-full-overlay { position: fixed; z-index: 1003; width: min(720px, calc(100vw - 24px)); max-height: calc(100vh - 64px); overflow: auto; padding: 14px; border: 1px solid var(--border-color); background: var(--comfy-menu-bg, #202020); box-shadow: 0 12px 32px #0009; }
